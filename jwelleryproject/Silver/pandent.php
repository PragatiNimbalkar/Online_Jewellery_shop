...
<table width="1327" border="0" >
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><table width="977" height="132" border="0">
      <tr>
        <th width="480" height="126" scope="col"><p><img src="../Images/Silver/Pendants Sets/11.jpg" width="295" height="205" /></p>
          <p>&nbsp;</p>
          <div align="center">
            <table width="225" height="69" border="">
              <tr>
                <th width="40" height="63" scope="col">Item Name</th>
                <th width="77" scope="col"><div align="center">Description</div></th>
                <th width="63" scope="col">Available</th>
                <th width="69" scope="col">Rs</th>
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p></th>
        <th width="487" scope="col"><p><img src="../Images/Silver/Pendants Sets/6.jpg" width="295" height="205" /></p>
          <div align="center">
            <table width="225" height="69" border="">
              <tr>
      ...
      <table width="978" height="137" border="0">
        <tr>
          <th width="485" scope="col"><p><img src="../Images/Silver/Pendants Sets/1.jpg" width="295" height="205"/></p>
            <p>&nbsp;</p>
            <div align="center">
              <table width="227" height="69" border="">
                <tr>
                  ...
                  <th width="74" scope="col">Rs</th>
				   <th width="69" scope="col">Weight</th>
				  <th width="69" scope="col">delivery</th>
				   <th width="74" scope="col">Order</th>
                </tr>
                <?php
                     mysql_connect("localhost","root","");
          ...
          <th width="483" scope="col"><p><img src="../Images/Silver/Pendants Sets/8.jpg" width="295" height="205" /></p>
            <div align="center">
              <table width="227" height="69" border="">
                <tr>
                  <th width="60" height="63" scope="col">Item Name</th>
                  ...
                  <th width="71" scope="col">Available</th>
                  <th width="74" scope="col">Rs</th>
				    <th width="74" scope="col">Weight</th>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><table width="976" height="260">
      <tr>
        <th height="254" scope="col"><p><img src="../Images/Silver/Pendants Sets/2.jpg" width="295" height="205"/></p>
          <div align="center">
            <table width="227" height="69" border="">
              <tr>
                <th width="60" height="63" scope="col">Item Name</th>
        ...
        <th scope="col"><p><img src="../Images/Silver/Pendants Sets/7.jpg" width="295" height="205"/></p>
          <p>&nbsp;</p>
          <div align="center">
            <table width="227" height="69" border="">
              <tr>
