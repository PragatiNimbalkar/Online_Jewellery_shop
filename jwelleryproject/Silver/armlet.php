...
<table width="1423" border="0" >
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <p align="center"><font size="4"><a href="../feedback.php">Feedback </a></font></p></td>
    <td><table width="900" height="132" border="0">
      <tr>
        <th width="402" height="126" scope="col"><p><img src="../Images/Silver/Armlets/3.jpg"  width="295" height="205" />
		 <div align="center">
		 <div align="center">
           <table width="227" height="69" border="">
             ...
             <?php
                     ...
                     $sel=mysql_query("select * from silverprice WHERE `silverprice`.`sid` = 23");
        ...
        <th width="488" scope="col"><p><img src="../Images/Silver/Armlets/5.jpg"  width="295" height="205"/></p>
          <p>&nbsp;</p>
          <div align="center">
            <table width="227" height="69" border="">
              <tr>
              ...
              <?php
                     mysql_connect("localhost","root","");
                     mysql_select_db("jewellery");
                     $sel=mysql_query("select * from silverprice WHERE `silverprice`.`sid` = 24");
      ...
      <table width="894" height="137" border="0">
        <tr>
          <th width="441" scope="col"><p><img src="../Images/Silver/Armlets/6.jpg"  width="295" height="205"/></p>
            <div align="center">
              <table width="227" height="69" border="">
                <tr>
                  <th width="60" height="63" scope="col">Item Name</th>
                ...
                <?php
                     mysql_connect("localhost","root","");
                     mysql_select_db("jewellery");
                     $sel=mysql_query("select * from silverprice WHERE `silverprice`.`sid` = 25");
            ...
            <p><a href="view1.php"></a></p>
          <p>&nbsp;</p></th>
          <th width="443" scope="col"><p><img src="../Images/Silver/Armlets/4.jpg" width="295" height="205" /></p>
            <div align="center">
              <table width="227" height="69" border="">
                <tr>
                  <th width="60" height="63" scope="col">Item Name</th>
                ...
                <?php
                     mysql_connect("localhost","root","");
                     mysql_select_db("jewellery");
                     $sel=mysql_query("select * from silverprice WHERE `silverprice`.`sid` = 26");
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><table width="898" height="210" border="0">
      <tr>
        <th width="447" scope="col"><p><img src="../Images/Silver/Armlets/8.jpg" width="295" height="205" /></p>
          <div align="center">
            <table width="227" height="69" border="">
              <tr>
                <th width="60" height="63" scope="col">Item Name</th>
              ...
              <?php
                     mysql_connect("localhost","root","");
                     mysql_select_db("jewellery");
                     $sel=mysql_query("select * from silverprice WHERE `silverprice`.`sid` = 27");
          ...
          <p>&nbsp;</p>
          <p><a href="view1.php"></a></p></th>
        <th width="441" scope="col"><p><img src="../Images/Silver/Armlets/1.jpg" width="295" height="205" /></p>
          <div align="center">
            <table width="227" height="69" border="">
              <tr>
                <th width="60" height="63" scope="col">Item Name</th>
              ...
              <?php
                     mysql_connect("localhost","root","");
                     mysql_select_db("jewellery");
                     $sel=mysql_query("select * from silverprice WHERE `silverprice`.`sid` = 28");
