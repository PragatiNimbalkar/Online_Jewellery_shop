...
$mysql="INSERT INTO goldprice(name,gcarte,dcarte,price,available,weight,delivery) values('".$_POST['name']."','".$_POST['gcarte']."','".$_POST['dcarte']."','".$_POST['price']."','".$_POST['available']."','".$_POST['weight']."','".$_POST['delivery']."')";
