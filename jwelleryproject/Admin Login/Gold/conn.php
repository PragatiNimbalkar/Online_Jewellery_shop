...
$sel=mysql_query("select * from goldprice");
 ...
 echo " <tr>
	    ...
	    <td>".$row['available']."</td>
         <td>".$row['delivery']."</td>			
        <td><a href=\"usr_list.php?page=viw&rid=".$row['rid']."\">V</a></td>
        <td><a href=\"usr_list.php?page=edt&rid=".$row['rid']."\">E</a></td>
        <td><a href=\"usr_list.php?page=del&rid=".$row['rid']."\">D</a></td>
      </tr>";
	  }
...
function del_row()
{
if(mysql_query("delete from goldprice where id=".$_GET['rid']))
...
function viw_row()
{
	$sel=mysql_query("select * from goldprice where id=".$_GET['rid']."");
