...
//select record
$result=mysql_query("SELECT * FROM diamondprice where did=".$_GET['id']."");
...
if(isset($_POST['sub']))
{
$sql=("update diamondprice set name='".$_POST['name']."',gcarte='".$_POST['gcarte']."',dcarte='".$_POST['dcarte']."',price='".$_POST['price']."',available='".$_POST['available']."',weight='".$_POST['weight']."',delivery='".$_POST['delivery']."' where did=".$_GET['id']."");
if(!mysql_query($sql))
{
