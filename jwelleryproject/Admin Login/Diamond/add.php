...
<table width="100%" border="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td valign="middle" align="right">Gold Carte</td>
    <td>:</td>
    <td><input type="text" name="gcarte"></td>
    <td>&nbsp;</td>
  </tr>
   <tr>
    <td>&nbsp;</td>
    <td width="18%" valign="middle" align="right">Diamond Carte</td>
    <td width="2%">:</td>
    <td width="37%"><input type="text" name="dcarte"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
$mysql="INSERT INTO diamondprice(name,gcarte,dcarte,price,available,weight,delivery) values('".$_POST['name']."','".$_POST['gcarte']."','".$_POST['dcarte']."','".$_POST['price']."','".$_POST['available']."','".$_POST['weight']."','".$_POST['delivery']."')";
