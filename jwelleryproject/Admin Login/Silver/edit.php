...
//select record
$result=mysql_query("SELECT * FROM silverprice where sid=".$_GET['id']."");
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td>Description</td>
    <td>:</td>
    <td><input type="text" name="description" value="<?php  echo $c;?>" ?></td>
    <td>&nbsp;</td>
  </tr>
   <tr>
    <td>&nbsp;</td>
...
if(isset($_POST['sub']))
{
$sql=("update silverprice set name='".$_POST['name']."',description='".$_POST['description']."',price='".$_POST['price']."',available='".$_POST['available']."',weight='".$_POST['weight']."',delivery='".$_POST['delivery']."' where sid=".$_GET['id']."");
if(!mysql_query($sql))
{
