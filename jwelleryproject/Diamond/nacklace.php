...
<table width="1310" border="0" bgcolor="">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><table width="977" height="132" border="0">
      <tr>
        <th width="480" height="126" scope="col"><p><img src="../Images/Diamond/Necklaces/7.jpg" width="295" height="205"  />&nbsp;</p>
          <div align="center">
...
$sel=mysql_query("select * from diamondprice WHERE `diamondprice`.`did` = 7");
...
?>
        ...
        <th width="487" scope="col"><p>&nbsp;</p>
          <p><img src="../Images/Diamond/Necklaces/3.jpg"  width="295" height="205"  /></p>
          <div align="center">
            <table width="227" height="69" border="1">
              <tr>
                <th width="60" height="63" scope="col">Item Name</th>
...
mysql_connect("localhost","root","");
mysql_select_db("jewellery");
$sel=mysql_query("select * from diamondprice WHERE `diamondprice`.`did` = 8");
      ...
      <table width="978" height="137" border="0">
        <tr>
          <th width="478" scope="col"><p>&nbsp;</p>
            <p><img src="../Images/Diamond/Necklaces/4.jpg"  width="295" height="205" /></p>
            <p>&nbsp;</p>
            <div align="center">
              <div align="center">
                <table width="432" height="106" border="1">
                  <tr>
                    <th width="60" height="63" scope="col">Item Name</th>
                    <th width="60" scope="col">Gold Carte</th>
                    <th width="71" scope="col">Diamond carte</th>
...
mysql_connect("localhost","root","");
mysql_select_db("jewellery");
$sel=mysql_query("select * from diamondprice WHERE `diamondprice`.`did` = 9");
...
?>
            ...
            <p>&nbsp;</p>
          <p>&nbsp;</p></th>
          <th width="490" scope="col"><p>&nbsp;</p>
            <p>&nbsp;</p>
            <p><img src="../Images/Diamond/Necklaces/1.jpg"  width="295" height="205" /></p>
            <div align="center">
              <table width="227" height="69" border="1">
                <tr>
                  <th width="60" height="63" scope="col">Item Name</th>
...
mysql_connect("localhost","root","");
mysql_select_db("jewellery");
$sel=mysql_query("select * from diamondprice WHERE `diamondprice`.`did` = 10");
...
?>
  ...
  <tr bgcolor="">
    ...
    <td><p align="center">&nbsp;</p>
      <table width="980" height="170" border="0">
        <tr>
          <th scope="col"><p><a href="view1.php"><img src="../Images/Diamond/Necklaces/5.jpg"  width="295" height="205"  /></a></p>
            <div align="center">
              <table width="227" height="69" border="1">
                <tr>
                  <th width="60" height="63" scope="col">Item Name</th>
...
mysql_connect("localhost","root","");
mysql_select_db("jewellery");
$sel=mysql_query("select * from diamondprice WHERE `diamondprice`.`did` = 11");
...
?>
            ...
            <p><a href="view1.php"></a></p>
          <p>&nbsp;</p></th>
          <th scope="col"><p><img src="../Images/Diamond/Necklaces/2.jpg"  width="295" height="205" /></p>
            <div align="center">
              <table width="227" height="69" border="1">
                <tr>
                  <th width="60" height="63" scope="col">Item Name</th>
...
mysql_connect("localhost","root","");
mysql_select_db("jewellery");
$sel=mysql_query("select * from diamondprice WHERE `diamondprice`.`did` = 12");
